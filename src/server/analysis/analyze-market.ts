import { analyzeResponseSchema, type AnalyzeResponse, type MarketDataMode, type Timeframe, type UserStance } from "@/features/market-analysis/model";
...
export async function analyzeMarket({ timeframe, stance, mode }: { timeframe: Timeframe; stance: UserStance; mode: MarketDataMode }): Promise<AnalyzeResponse> {
